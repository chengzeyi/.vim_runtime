...
nnoremap <leader>ss :%s//<left><left>
nnoremap <leader>sc :%s//c<left><left><left>
xnoremap <leader>ss :s//<left><left>
xnoremap <leader>sc :s//c<left><left><left>
nnoremap <leader>qs :cdo s//<left><left>
nnoremap <leader>qc :cdo s//c<left><left><left>
nnoremap <leader>ls :ldo s//<left><left>
nnoremap <leader>lc :ldo s//c<left><left><left>
nnoremap <leader>bs :bufdo %s//<left><left>
nnoremap <leader>bc :bufdo %s//c<left><left><left>
